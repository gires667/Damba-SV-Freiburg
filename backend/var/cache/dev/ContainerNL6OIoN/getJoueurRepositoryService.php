 ...
 */
class getJoueurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JoueurRepository' shared autowired service.
     *
     * @return \App\Repository\JoueurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JoueurRepository.php';

        return $container->privates['App\\Repository\\JoueurRepository'] = new \App\Repository\JoueurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
