 ...
 */
class getSupporterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SupporterRepository' shared autowired service.
     *
     * @return \App\Repository\SupporterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SupporterRepository.php';

        return $container->privates['App\\Repository\\SupporterRepository'] = new \App\Repository\SupporterRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
